...
I'M SORRY! Unavailable for now, because already have a gem named sparrow. I will change it name.

=== Example

===== Three steps to send and receive JMS messages to/from a JMS middleware.
